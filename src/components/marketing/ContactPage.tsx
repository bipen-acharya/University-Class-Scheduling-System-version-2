    ...
    return (
      <div className="min-h-screen bg-[#F8FAFC] flex items-center justify-center py-20 px-4">
        <div className="max-w-2xl w-full bg-white rounded-2xl shadow-xl p-12 text-center">
          ...
          <h2 className="text-3xl text-[#0F172A] mb-4">
            Request Received!
          </h2>

          <p className="text-xl text-[#0F172A] mb-8">
            Thank you for your interest in UniScheduling. Our team will review
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-4 bg-gradient-to-r from-[#2563EB] to-[#3B82F6] text-white rounded-xl hover:shadow-lg hover:shadow-blue-500/50 transition-all flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
                >
                  <Send className="w-5 h-5" />
                  {loading ? "Sending Request..." : "Request My System"}
                </button>
              </form>
            </div>
          </div>
