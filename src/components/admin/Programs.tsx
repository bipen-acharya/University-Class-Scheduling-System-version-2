...
const samplePrograms: Program[] = [
  { id: '1', name: 'Bachelor of ICT', level: 'Bachelor', status: 'Active' },
  { id: '2', name: 'Bachelor of Nursing', level: 'Bachelor', status: 'Active' },
  { id: '3', name: 'Bachelor of Early Childhood', level: 'Bachelor', status: 'Active' },
  { id: '4', name: 'Masters in ICT', level: 'Master', status: 'Active' },
  { id: '5', name: 'Masters in Cybersecurity', level: 'Master', status: 'Active' },
];
...
export default function Programs() {
  ...
  const [programLevel, setProgramLevel] = useState<'Bachelor' | 'Master' | 'PhD' | 'Other'>('Bachelor');
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-lg shadow-card p-6 border border-light">
          ...
          <p className="text-3xl text-green-600">{programs.filter(p => p.status === 'Active').length}</p>
        </div>
        <div className="bg-white rounded-lg shadow-card p-6 border border-light">
          <p className="text-sm text-body mb-2">Bachelor Programs</p>
          <p className="text-3xl text-blue-600">{programs.filter(p => p.level === 'Bachelor').length}</p>
        </div>
        <div className="bg-white rounded-lg shadow-card p-6 border border-light">
          <p className="text-sm text-body mb-2">Master Programs</p>
          <p className="text-3xl text-purple-600">{programs.filter(p => p.level === 'Master').length}</p>
        </div>
      </div>
            ...
            <div className="bg-white rounded-xl max-w-lg w-full shadow-2xl">
              ...
              <div className="p-6 space-y-6">
                <div className="flex items-center gap-4 pb-4 border-b border-light">
                  ...
                  <div>
                    <h3 className="text-dark text-lg">{selectedProgram.name}</h3>
                    <p className="text-body text-sm">Academic Program</p>
                  </div>
                </div>

                <div>
                  <label className="text-sm text-body mb-1 block">Level / Type</label>
