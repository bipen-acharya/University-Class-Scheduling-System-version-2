  ...
  async function loadSettings() {
    ...
    try {
      ...
      setForm({
        ...
        ...payload,
        slot_duration_minutes: Number(
          payload?.slot_duration_minutes ?? DEFAULTS.slot_duration_minutes,
        ),
        slot_gap_minutes: Number(
          payload?.slot_gap_minutes ?? DEFAULTS.slot_gap_minutes,
        ),
        conflict_alerts: Boolean(
          payload?.conflict_alerts ?? DEFAULTS.conflict_alerts,
        ),
        timesheet_reminders: Boolean(
          payload?.timesheet_reminders ?? DEFAULTS.timesheet_reminders,
        ),
        class_updates: Boolean(
          payload?.class_updates ?? DEFAULTS.class_updates,
        ),
        working_days: (payload?.working_days ??
          DEFAULTS.working_days) as WorkingDays,
      });
    } catch (e: any) {
    ...
    <div className="space-y-6 relative">
      ...
      <div className="flex justify-end">
        <button
          ...
          disabled={saving}
          className="flex items-center gap-2 px-6 py-2 bg-primary-blue text-white rounded-xl hover:opacity-90 transition-all shadow-card-lg disabled:opacity-60 disabled:cursor-not-allowed"
        >
      ...
      <div className="bg-white rounded-2xl shadow-card-lg p-6 border border-light">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-sm text-body">
              Configure your institution details
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label className="block text-sm text-dark mb-2 font-medium">
              Institution Name
            </label>
            <input
              type="text"
              ...
              onChange={(e) =>
                setForm((p) => ({
                  ...p,
                  university_name: e.target.value || null,
                }))
              }
          ...
          <div>
            ...
            <p className="text-xs text-body mt-2">
              Use IANA format (e.g., Australia/Sydney)
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-card-lg p-6 border border-light">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-sm text-body">
              Configure class timing and schedule
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setForm((p) => ({ ...p, day_start_time: e.target.value }))
              }
              className="w-full px-4 py-3 border border-light rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-blue focus:border-transparent bg-white"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setForm((p) => ({ ...p, day_end_time: e.target.value }))
              }
              className="w-full px-4 py-3 border border-light rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-blue focus:border-transparent bg-white"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setForm((p) => ({
                  ...p,
                  slot_gap_minutes: Number(e.target.value),
                }))
              }
              className="w-full px-4 py-3 border border-light rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-blue focus:border-transparent bg-white"
            />
          ...
          <div className="md:col-span-2">
            ...
            <select
              ...
              onChange={(e) =>
                setForm((p) => ({
                  ...p,
                  working_days: e.target.value as WorkingDays,
                }))
              }
            ...
            <p className="text-xs text-body mt-2">
              Currently selected: {workingDaysLabel}
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between p-4 bg-soft rounded-xl">
            <div>
              ...
              <p className="text-xs text-body">
                Get notified when scheduling conflicts occur
              </p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                ...
                onChange={(e) =>
                  setForm((p) => ({ ...p, conflict_alerts: e.target.checked }))
                }
          ...
          <div className="flex items-center justify-between p-4 bg-soft rounded-xl">
            <div>
              ...
              <p className="text-xs text-body">
                Send reminders for timesheet actions
              </p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                ...
                onChange={(e) =>
                  setForm((p) => ({
                    ...p,
                    timesheet_reminders: e.target.checked,
                  }))
                }
                className="sr-only peer"
              />
          ...
          <div className="flex items-center justify-between p-4 bg-soft rounded-xl">
            <div>
              ...
              <p className="text-xs text-body">
                Notify users when classes are updated
              </p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                ...
                onChange={(e) =>
                  setForm((p) => ({ ...p, class_updates: e.target.checked }))
                }
                className="sr-only peer"
              />
              <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-100 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-primary-blue"></div>
        ...
        <div className="bg-white rounded-2xl shadow-card-lg p-6 border border-light">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-body">Logged-in user information</p>
            </div>
          </div>
